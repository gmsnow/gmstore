...
const CATEGORIES = [
  ...
  },
  {
    name: "المنزل والمطبخ", nameEn: "Home & Kitchen", children: [
      { name: "كنب", nameEn: "Sofas" },
      { name: "أسرة", nameEn: "Beds" },
      { name: "مراتب", nameEn: "Mattresses" },
      { name: "وسائد", nameEn: "Pillows" },
      { name: "أغطية", nameEn: "Blankets" },
      { name: "ستائر", nameEn: "Curtains" },
      { name: "سجاد", nameEn: "Carpets" },
      { name: "طاولات", nameEn: "Tables" },
      { name: "كراسي", nameEn: "Chairs" },
      { name: "خزائن", nameEn: "Cabinets" },
      { name: "دواليب", nameEn: "Wardrobes" },
      { name: "رفوف", nameEn: "Shelves" },
      { name: "مرايا", nameEn: "Mirrors" },
      { name: "إضاءة", nameEn: "Lighting" },
      { name: "ديكور حائط", nameEn: "Wall Decor" },
      { name: "ساعات حائط", nameEn: "Clocks" },
      { name: "أجهزة مطبخ", nameEn: "Kitchen Appliances", children: [
        ...
        { name: "عجانات", nameEn: "Mixers" },
        { name: "عصارات", nameEn: "Juicers" },
      ]},
      { name: "أواني طبخ", nameEn: "Cookware", children: [
        { name: "مقالي", nameEn: "Frying Pans" },
        { name: "قدور", nameEn: "Pots" },
        { name: "حلل ضغط", nameEn: "Pressure Cookers" },
        { name: "سكاكين", nameEn: "Knives" },
        { name: "ألواح تقطيع", nameEn: "Cutting Boards" },
      ]},
      { name: "أطباق", nameEn: "Plates" },
      { name: "سلطانيات", nameEn: "Bowls" },
      { name: "أكواب", nameEn: "Cups" },
      { name: "كاسات", nameEn: "Glasses" },
      { name: "قوارير ماء", nameEn: "Water Bottles" },
      { name: "علب غداء", nameEn: "Lunch Boxes" },
      ...
      { name: "مستلزمات تنظيف", nameEn: "Cleaning Supplies", children: [
        ...
        { name: "مكانس يدوية", nameEn: "Brooms" },
        { name: "مستلزمات غسيل", nameEn: "Laundry Supplies" },
      ]},
      { name: "مستلزمات حمام", nameEn: "Bathroom Accessories" },
      { name: "مناشف", nameEn: "Towels" },
      { name: "أغطية سرير", nameEn: "Bed Sheets" },
  ...
  },
  {
    name: "تجميل", nameEn: "Beauty", children: [
      { name: "مكياج", nameEn: "Makeup", children: [
        ...
        { name: "ماسكرا", nameEn: "Mascara" },
        { name: "آيلاينر", nameEn: "Eyeliner" },
      ]},
      { name: "عناية بالبشرة", nameEn: "Skincare", children: [
        ...
        { name: "سيروم", nameEn: "Serums" },
        { name: "تونر", nameEn: "Toners" },
      ]},
      { name: "عناية بالشعر", nameEn: "Hair Care", children: [
        { name: "شامبو", nameEn: "Shampoo" },
        { name: "بلسم", nameEn: "Conditioner" },
        { name: "زيت شعر", nameEn: "Hair Oil" },
        { name: "مجففات شعر", nameEn: "Hair Dryers" },
        { name: "مكواة شعر", nameEn: "Hair Straighteners" },
        { name: "مكواة تجعيد", nameEn: "Hair Curlers" },
      ]},
      { name: "عطور", nameEn: "Perfumes" },
      { name: "بودي سبراي", nameEn: "Body Spray" },
      { name: "مزيل عرق", nameEn: "Deodorants" },
      { name: "طلاء أظافر", nameEn: "Nail Polish" },
      { name: "عناية بالأظافر", nameEn: "Nail Care" },
      { name: "ماكينة حلاقة", nameEn: "Shaving" },
  ...
  },
  {
    name: "صحة", nameEn: "Health", children: [
      ...
      { name: "معدات طبية", nameEn: "Medical Equipment", children: [
        { name: "أجهزة ضغط", nameEn: "Blood Pressure Monitors" },
        { name: "ترمومترات", nameEn: "Thermometers" },
        { name: "حقائب إسعافات", nameEn: "First Aid Kits" },
      ]},
      { name: "كمامات وجه", nameEn: "Face Masks" },
      { name: "قفازات طبية", nameEn: "Gloves" },
      { name: "كراسي متحركة", nameEn: "Wheelchairs" },
      { name: "عكازات", nameEn: "Walking Canes" },
      { name: "سماعات أذن طبية", nameEn: "Hearing Aids" },
      { name: "أجهزة مساج", nameEn: "Massagers" },
      { name: "دعامات ظهر", nameEn: "Back Support" },
      { name: "دعامات ركبة", nameEn: "Knee Support" },
      { name: "عناية بالعيون", nameEn: "Eye Care", children: [
        { name: "عدسات لاصقة", nameEn: "Contact Lenses" },
      ]},
      { name: "مسكنات ألم", nameEn: "Pain Relief" },
      { name: "كمادات ماء ساخن", nameEn: "Hot Water Bags" },
      { name: "مرطبات جو", nameEn: "Humidifiers" },
      { name: "منقيات هواء", nameEn: "Air Purifiers" },
    ],
  },
  {
    name: "رياضة", nameEn: "Sports", children: [
      ...
      { name: "كرة طائرة", nameEn: "Volleyball" },
      { name: "تنس", nameEn: "Tennis" },
      { name: "ريشة طائرة", nameEn: "Badminton" },
      { name: "سباحة", nameEn: "Swimming" },
      { name: "دراجات", nameEn: "Cycling" },
      { name: "جري", nameEn: "Running" },
      { name: "تخييم", nameEn: "Camping" },
      { name: "تنزه", nameEn: "Hiking" },
      ...
      { name: "ملاكمة", nameEn: "Boxing" },
      { name: "فنون قتالية", nameEn: "Martial Arts" },
      { name: "سكيت بورد", nameEn: "Skateboards" },
      { name: "سكوتر", nameEn: "Scooters" },
  ...
  },
  {
    name: "سيارات", nameEn: "Automotive", children: [
      ...
      { name: "إطارات", nameEn: "Tires" },
      { name: "بطاريات سيارة", nameEn: "Car Batteries" },
      { name: "زيت محرك", nameEn: "Engine Oil" },
      { name: "إلكترونيات السيارة", nameEn: "Car Electronics", children: [
        { name: "ملاحة GPS", nameEn: "GPS Navigation" },
        { name: "كاميرات داش", nameEn: "Dash Cameras" },
      ]},
      { name: "أغطية مقاعد", nameEn: "Seat Covers" },
      { name: "فرش سيارة", nameEn: "Car Mats" },
      { name: "منظفات سيارة", nameEn: "Car Cleaning" },
      { name: "دراجات نارية", nameEn: "Motorcycles" },
      { name: "خوذ دراجات", nameEn: "Motorcycle Helmets" },
      { name: "إكسسوارات دراجات", nameEn: "Bicycle Accessories" },
      { name: "أدوات سيارة", nameEn: "Car Tools", children: [
        { name: "ضواغط هواء", nameEn: "Air Compressors" },
        { name: "أجهزة تشغيل", nameEn: "Jump Starters" },
        { name: "مساحات زجاج", nameEn: "Wiper Blades" },
      ]},
      { name: "إضاءة سيارة", nameEn: "Car Lights" },
      { name: "حوامل سقف", nameEn: "Roof Racks" },
  ...
  },
  {
    name: "ألعاب وأطفال", nameEn: "Toys & Baby", children: [
      { name: "ألعاب", nameEn: "Toys", children: [
        ...
        { name: "ألعاب تحكم", nameEn: "RC Toys" },
      ...
      { name: "رضاعة", nameEn: "Baby Feeding", children: [
        { name: "رضاعات", nameEn: "Baby Bottles" },
        { name: "حفاضات", nameEn: "Baby Diapers" },
        { name: "مناديل مبللة", nameEn: "Baby Wipes" },
      ]},
      { name: "سلامة الطفل", nameEn: "Baby Safety" },
      { name: "مراقبة الطفل", nameEn: "Baby Monitors" },
      { name: "أثاث أطفال", nameEn: "Baby Furniture" },
      { name: "مشايات أطفال", nameEn: "Baby Walkers" },
      { name: "حمالات أطفال", nameEn: "Baby Carriers" },
      { name: "استحمام الطفل", nameEn: "Baby Bath" },
      { name: "عناية بشرة الطفل", nameEn: "Baby Skincare" },
      { name: "فراش أطفال", nameEn: "Baby Bedding" },
    ],
  },
  {
    name: "كتب وأدوات مكتبية", nameEn: "Books & Office", children: [
      ...
      { name: "أقلام رصاص", nameEn: "Pencils" },
      { name: "ماركر", nameEn: "Markers" },
      { name: "كراسي مكتب", nameEn: "Office Chairs" },
      { name: "مكاتب", nameEn: "Office Desks" },
      { name: "ورق", nameEn: "Paper" },
      { name: "طابعات", nameEn: "Printers" },
      { name: "مستلزمات مكتبية", nameEn: "Office Supplies" },
      { name: "آلات حاسبة", nameEn: "Calculators" },
      { name: "سبورات بيضاء", nameEn: "Whiteboards" },
      { name: "ملفات ومجلدات", nameEn: "Files & Folders" },
      { name: "ملاحظات لاصقة", nameEn: "Sticky Notes" },
      { name: "دباسات", nameEn: "Staplers" },
  ...
  },
  {
    name: "مستلزمات حيوانات", nameEn: "Pet Supplies", children: [
      ...
      { name: "طعام طيور", nameEn: "Bird Food" },
      { name: "طعام أسماك", nameEn: "Fish Food" },
      { name: "ألعاب حيوانات", nameEn: "Pet Toys" },
      { name: "أسرة حيوانات", nameEn: "Pet Beds" },
      { name: "عناية بالحيوانات", nameEn: "Pet Grooming" },
      { name: "حاملات حيوانات", nameEn: "Pet Carriers" },
      { name: "رمل قطط", nameEn: "Cat Litter" },
      { name: "أحواض أسماك", nameEn: "Aquariums" },
    ],
  },
  {
    name: "طعام وبقالة", nameEn: "Food & Grocery", children: [
      { name: "أرز", nameEn: "Rice" },
      { name: "مكرونة", nameEn: "Pasta" },
      { name: "زيت طبخ", nameEn: "Cooking Oil" },
      { name: "دقيق", nameEn: "Flour" },
      { name: "سكر", nameEn: "Sugar" },
      { name: "ملح", nameEn: "Salt" },
      { name: "شاي", nameEn: "Tea" },
      ...
      { name: "معلبات", nameEn: "Canned Food" },
      { name: "أغذية مجمدة", nameEn: "Frozen Food" },
      { name: "منتجات ألبان", nameEn: "Dairy Products", children: [
        { name: "جبن", nameEn: "Cheese" },
        { name: "زبدة", nameEn: "Butter" },
      ]},
      { name: "بيض", nameEn: "Eggs" },
      { name: "عسل", nameEn: "Honey" },
      { name: "مربى", nameEn: "Jam" },
    ],
  },
  {
    name: "أثاث", nameEn: "Furniture", children: [
      ...
      { name: "أثاث خارجي", nameEn: "Outdoor Furniture" },
      { name: "طاولات تلفزيون", nameEn: "TV Stands" },
      { name: "رفوف كتب", nameEn: "Bookshelves" },
      { name: "رفوف أحذية", nameEn: "Shoe Racks" },
      { name: "طاولات زينة", nameEn: "Vanity Tables" },
      { name: "طاولات تسريحة", nameEn: "Dressing Tables" },
    ],
  },
  {
    name: "حديقة", nameEn: "Garden", children: [
      { name: "نباتات", nameEn: "Plants" },
      { name: "بذور", nameEn: "Seeds" },
      { name: "أصص زرع", nameEn: "Flower Pots" },
      { name: "أدوات حديقة", nameEn: "Garden Tools" },
      { name: "جزازات عشب", nameEn: "Lawn Mowers" },
      { name: "خراطيم مياه", nameEn: "Water Hoses" },
      { name: "إضاءة خارجية", nameEn: "Outdoor Lighting" },
      { name: "شوايات", nameEn: "BBQ Grills" },
      { name: "أثاث حديقة", nameEn: "Garden Furniture" },
      { name: "أسمدة", nameEn: "Fertilizers" },
    ],
  },
  {
    name: "صناعي", nameEn: "Industrial", children: [
      { name: "أدوات كهربائية", nameEn: "Power Tools" },
      { name: "أدوات يدوية", nameEn: "Hand Tools" },
      { name: "معدات سلامة", nameEn: "Safety Equipment" },
      { name: "معدات لحام", nameEn: "Welding Equipment" },
      { name: "مولدات", nameEn: "Generators" },
      { name: "ضواغط هواء", nameEn: "Air Compressors" },
      { name: "مضخات", nameEn: "Pumps" },
      { name: "أدوات قياس", nameEn: "Measuring Tools" },
      { name: "مواد بناء", nameEn: "Construction Materials" },
      { name: "مستلزمات كهربائية", nameEn: "Electrical Supplies" },
    ],
  },
  {
    name: "ألعاب إلكترونية", nameEn: "Gaming", children: [
      { name: "أجهزة ألعاب", nameEn: "Gaming Consoles" },
      { name: "ألعاب بلايستيشن", nameEn: "PlayStation Games" },
      { name: "ألعاب إكس بوكس", nameEn: "Xbox Games" },
      { name: "ألعاب نينتندو", nameEn: "Nintendo Games" },
      { name: "ألعاب كمبيوتر", nameEn: "PC Games" },
      { name: "كراسي ألعاب", nameEn: "Gaming Chairs" },
      { name: "كيبورد ألعاب", nameEn: "Gaming Keyboards" },
      { name: "ماوس ألعاب", nameEn: "Gaming Mice" },
      { name: "شاشات ألعاب", nameEn: "Gaming Monitors" },
      { name: "إكسسوارات ألعاب", nameEn: "Gaming Accessories" },
    ],
  },
  {
    name: "منتجات رقمية", nameEn: "Digital Products", children: [
      { name: "برامج", nameEn: "Software", children: [
        { name: "أنتي فيروس", nameEn: "Antivirus" },
        { name: "أنظمة تشغيل", nameEn: "Operating Systems" },
      ]},
      { name: "دورات أونلاين", nameEn: "Online Courses" },
      { name: "كتب إلكترونية", nameEn: "E-books" },
      { name: "بطاقات هدايا", nameEn: "Gift Cards" },
      { name: "موسيقى رقمية", nameEn: "Digital Music" },
      { name: "قوالب فيديو", nameEn: "Video Templates" },
      { name: "ثيمات مواقع", nameEn: "Website Themes" },
      { name: "إضافات", nameEn: "Plugins" },
    ],
  },
  {
    name: "متنوعات", nameEn: "Miscellaneous", children: [
      { name: "هدايا", nameEn: "Gifts" },
      { name: "مستلزمات حفلات", nameEn: "Party Supplies" },
      { name: "ديكورات موسمية", nameEn: "Seasonal Decorations", children: [
        { name: "ديكورات كريسماس", nameEn: "Christmas Decorations" },
        { name: "ديكورات هالووين", nameEn: "Halloween Decorations" },
      ]},
      { name: "مستلزمات زفاف", nameEn: "Wedding Supplies" },
      { name: "مواد دينية", nameEn: "Religious Items" },
      { name: "تحف", nameEn: "Collectibles" },
      { name: "آلات موسيقية", nameEn: "Musical Instruments" },
      { name: "إكسسوارات موسيقية", nameEn: "Musical Accessories" },
      { name: "مستلزمات سفر", nameEn: "Travel Accessories" },
      { name: "مستلزمات خياطة", nameEn: "Sewing Supplies" },
      { name: "أقمشة", nameEn: "Fabrics" },
      { name: "مواد نسيج", nameEn: "Textile Materials" },
      { name: "منتجات جلدية", nameEn: "Leather Goods" },
      { name: "مستلزمات حرفية", nameEn: "Craft Kits" },
      { name: "مستلزمات تدخين", nameEn: "Smoking Accessories" },
      { name: "أدوات إصلاح جوال", nameEn: "Phone Repair Tools" },
      { name: "أدوات إصلاح كمبيوتر", nameEn: "Computer Repair Tools" },
      { name: "معدات مختبر", nameEn: "Lab Equipment" },
      { name: "مستلزمات تعليمية", nameEn: "Educational Supplies" },
      { name: "مستلزمات مطاعم", nameEn: "Restaurant Supplies" },
      { name: "مستلزمات فنادق", nameEn: "Hotel Supplies" },
      { name: "معدات صالونات", nameEn: "Beauty Salon Equipment" },
      { name: "معدات حلاقة", nameEn: "Barbershop Equipment" },
      { name: "مستلزمات تغليف", nameEn: "Packaging Supplies" },
      { name: "منتجات جملة", nameEn: "Wholesale Products" },
      { name: "تخفيضات", nameEn: "Clearance Items" },
      { name: "وصل حديثاً", nameEn: "New Arrivals" },
