    ...
    <div className="relative bg-white overflow-hidden transition-transform duration-300 hover:-translate-y-1">
      ...
      <Link href={`/products/${product.slug}`} className="block">
        <div className="p-3 md:p-5 text-center">
          <h3 className="text-sm sm:text-lg md:text-2xl leading-relaxed text-[#2092EB] font-normal mb-2 md:mb-4">
            <LocalizedName item={product} />
          </h3>

          <div className="text-[#2092EB] text-xs sm:text-base md:text-[22px] mb-2 md:mb-4">
            {avgRating > 0 ? (
          ...
          <div className="flex items-center justify-center gap-2 md:gap-3 flex-wrap">
            <span className="text-xs sm:text-base md:text-[22px] text-[#2092EB] line-through">{formatPrice("yer")} {currencyLabels.yer}</span>
          </div>
          <div className="flex items-center justify-center gap-2 md:gap-3 flex-wrap mt-1">
            <span className="text-sm sm:text-xl md:text-[26px] font-bold text-[#2092EB]">{formatPrice(displayCurrency)} {currencyLabels[displayCurrency]}</span>
          </div>
